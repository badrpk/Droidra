...
android {
    namespace = "com.badrpk.rangoons"
    compileSdk = 34
    defaultConfig {
        applicationId = "com.badrpk.rangoons"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
