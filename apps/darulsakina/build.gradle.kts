...
android {
    namespace = "com.badrpk.darulsakina"
    compileSdk = 34
    defaultConfig {
        applicationId = "com.badrpk.darulsakina"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
        ...
        buildConfigField("String", "APP_NAME", "\"Darul Sakina\"")
        buildConfigField("String", "GCP_API_KEY", "\"${prop("GCP_API_KEY", prop("GOOGLE_API_KEY"))}\"")
        resValue("string", "app_name", "Darul Sakina")
    }
    signingConfigs {
        create("release") {
